...
public class Challenge {
	...
	public void executeJunitTestCase(ProductGeneration tools) {
		...
		for (Combination combination : tools.getCombsForTest()) {
			for (FeatureCombination f : combination.getListFeatures()) {
				...
				} else if (f.getName().equals("Resizable")) {
				...
				} else if (f.getName().equals("SupportedFormats")) {
				...
				} else if (f.getName().equals("Control")) {
				...
				} else if (f.getName().equals("ID3Information")) {
	...
	public static void main(String[] args) {
		...
		while (index < totalExecution) {
			...
			/** all_valid_conf **/
			String path = "C:/Users/Fischer_PC/Documents/2019_CSS_Journal/workspace_IncLing/Tools/All_valid_conf/FeatureAMP1/products";
