...
public class Configuration {
	...
	public static String setAVOIDESCAPEDUNICODECHARACTERS() {
		return (AvoidEscapedUnicodeCharacters) ? "AVOIDESCAPEDUNICODECHARACTERS___"
	...
	public static String setCLASSDATAABSTRACTIONCOUPLINGCHECK() {
		return (ClassDataAbstractionCouplingCheck) ? "CLASSDATAABSTRACTIONCOUPLINGCHECK___"
	...
	public static String setINDENTATIONFORCESTRICTCONDITION() {
		return (IndentationForceStrictCondition) ? "INDENTATIONFORCESTRICTCONDITION___"
	...
	public static String setOVERLOADMETHODSDECLARATIONORDER() {
		return (OverloadMethodsDeclarationOrder) ? "OVERLOADMETHODSDECLARATIONORDER___"
	...
	public static String setVARIABLEDECLARATIONUSAGEDISTANCE() {
		return (VariableDeclarationUsageDistance) ? "VARIABLEDECLARATIONUSAGEDISTANCE___"
	...
	public static String setJAVADOCTAGCONTINUATIONINDENTATION() {
		return (JavadocTagContinuationIndentation) ? "JAVADOCTAGCONTINUATIONINDENTATION___"
	...
	public static String setABBREVIATIONASWORDINNAMEIGNOREFINAL() {
		return (AbbreviationAsWordInNameignoreFinal) ? "ABBREVIATIONASWORDINNAMEIGNOREFINAL___"
				: "-ABBREVIATIONASWORDINNAMEIGNOREFINAL___";
	}

	public static String setABBREVIATIONASWORDINNAMEIGNORESTATIC() {
		return (AbbreviationAsWordInNameignoreStatic) ? "ABBREVIATIONASWORDINNAMEIGNORESTATIC___"
				: "-ABBREVIATIONASWORDINNAMEIGNORESTATIC___";
	}

	public static String setABBREVIATIONASWORDINNAMEIGNOREOVERRIDDENMETHODS() {
		return (AbbreviationAsWordInNameignoreOverriddenMethods) ? "ABBREVIATIONASWORDINNAMEIGNOREOVERRIDDENMETHODS___"
	...
	public static String setABSTRACTCLASSNAMEIGNOREMODIFIER() {
		return (AbstractClassNameignoreModifier) ? "ABSTRACTCLASSNAMEIGNOREMODIFIER___"
	...
	public static String setLOCALVARIABLENAMEALLOWONECHARVARINFORLOOP() {
		return (LocalVariableNameallowOneCharVarInForLoop) ? "LOCALVARIABLENAMEALLOWONECHARVARINFORLOOP___"
	...
	public static String setEMPTYLINESEPARATORALLOWNOEMPTYLINEBETWEENFIELDS() {
		return (EmptyLineSeparatorallowNoEmptyLineBetweenFields) ? "EMPTYLINESEPARATORALLOWNOEMPTYLINEBETWEENFIELDS___"
				: "-EMPTYLINESEPARATORALLOWNOEMPTYLINEBETWEENFIELDS___";
	}

	public static String setEMPTYLINESEPARATORALLOWMULTIPLEEMPTYLINES() {
		return (EmptyLineSeparatorallowMultipleEmptyLines) ? "EMPTYLINESEPARATORALLOWMULTIPLEEMPTYLINES___"
	...
	public static String setWHITESPACEAROUNDALLOWEMPTYCTORS() {
		return (WhitespaceAroundAllowEmptyCtors) ? "WHITESPACEAROUNDALLOWEMPTYCTORS___"
				: "-WHITESPACEAROUNDALLOWEMPTYCTORS___";
	}

	public static String setWHITESPACEAROUNDALLOWEMPTYMETHODS() {
		return (WhitespaceAroundAllowEmptyMethods) ? "WHITESPACEAROUNDALLOWEMPTYMETHODS___"
				: "-WHITESPACEAROUNDALLOWEMPTYMETHODS___";
	}

	public static String setWHITESPACEAROUNDALLOWEMPTYTYPES() {
		return (WhitespaceAroundAllowEmptyTypes) ? "WHITESPACEAROUNDALLOWEMPTYTYPES___"
				: "-WHITESPACEAROUNDALLOWEMPTYTYPES___";
	}

	public static String setWHITESPACEAROUNDALLOWEMPTYLOOPS() {
		return (WhitespaceAroundAllowEmptyLoops) ? "WHITESPACEAROUNDALLOWEMPTYLOOPS___"
				: "-WHITESPACEAROUNDALLOWEMPTYLOOPS___";
	}

	public static String setWHITESPACEAROUNDIGNOREENHANCEDFORCOLON() {
		return (WhitespaceAroundIgnoreEnhancedForColon) ? "WHITESPACEAROUNDIGNOREENHANCEDFORCOLON___"
	...
	public static void productPrint() {
		System.out.println(
				...
				"WRITETAG:" + Configuration.WriteTag + "WHITESPACEAROUNDIGNOREENHANCEDFORCOLON:"
						+ Configuration.WhitespaceAroundIgnoreEnhancedForColon + "WHITESPACEAROUNDALLOWEMPTYTYPES:"
						+ Configuration.WhitespaceAroundAllowEmptyTypes + "WHITESPACEAROUNDALLOWEMPTYMETHODS:"
						+ Configuration.WhitespaceAroundAllowEmptyMethods + "WHITESPACEAROUNDALLOWEMPTYLOOPS:"
						+ Configuration.WhitespaceAroundAllowEmptyLoops + "WHITESPACEAROUNDALLOWEMPTYCTORS:"
						+ Configuration.WhitespaceAroundAllowEmptyCtors + "WHITESPACEAROUND:"
						+ Configuration.WhitespaceAround + "WHITESPACEAFTER:" + Configuration.WhitespaceAfter
						+ "VISIBILITYMODIFIER:" + Configuration.VisibilityModifier + "VARIABLEDECLARATIONUSAGEDISTANCE:"
						+ Configuration.VariableDeclarationUsageDistance + "UPPERELL:" + Configuration.UpperEll
						+ "UNUSEDIMPORTS:" + Configuration.UnusedImports + "UNNECESSARYPARENTHESES:"
						+ Configuration.UnnecessaryParentheses + "UNCOMMENTEDMAIN:" + Configuration.UncommentedMain
						+ "TYPECASTPARENPAD:" + Configuration.TypecastParenPad + "TYPENAME:" + Configuration.TypeName
						+ "TRANSLATION:" + Configuration.Translation + "TRAILINGCOMMENT:"
						+ Configuration.TrailingComment + "TODOCOMMENT:" + Configuration.TodoComment + "THROWSCOUNT:"
						+ Configuration.ThrowsCount + "TW:" + Configuration.TW + "SUPPRESSWARNINGS:"
						+ Configuration.SuppressWarnings + "SUPERFINALIZE:" + Configuration.SuperFinalize
						+ "SUPERCLONE:" + Configuration.SuperClone + "SUMMARYJAVADOC:" + Configuration.SummaryJavadoc
						+ "STRINGLITERALEQUALITY:" + Configuration.StringLiteralEquality + "STATICVARIABLENAME:"
						+ Configuration.StaticVariableName + "SINGLELINEJAVADOC:" + Configuration.SingleLineJavadoc
						+ "SIMPLIFYBOOLEANRETURN:" + Configuration.SimplifyBooleanReturn + "SIMPLIFYBOOLEANEXPRESSION:"
						+ Configuration.SimplifyBooleanExpression + "SEPARATORWRAP:" + Configuration.SeparatorWrap
						+ "RIGHTCURLY:" + Configuration.RightCurly + "RETURNCOUNTCHECK:"
						+ Configuration.ReturnCountCheck + "REQUIRETHIS:" + Configuration.RequireThis
						+ "REGEXPILLEGALPATTERN:" + Configuration.RegexpillegalPattern + "REGEXPIGNORECOMMENTS:"
						+ Configuration.RegexpignoreComments + "REGEXPCHECKFORDUPLICATES:"
						+ Configuration.RegexpcheckForDuplicates + "REGEXPSINGLELINEJAVA:"
						+ Configuration.RegexpSinglelineJava + "REGEXPSINGLELINE:" + Configuration.RegexpSingleline
						+ "REGEXPMULTILINE:" + Configuration.RegexpMultiline + "REGEXPHEADERCHECK:"
						+ Configuration.RegexpHeaderCheck + "REGEXP:" + Configuration.Regexp + "REDUNDANTMODIFIER:"
						+ Configuration.RedundantModifier + "REDUNDANTIMPORT:" + Configuration.RedundantImport
						+ "PARENPAD:" + Configuration.ParenPad + "PARAMETERNUMBER:" + Configuration.ParameterNumber
						+ "PARAMETERNAME:" + Configuration.ParameterName + "PARAMETERASSIGNMENT:"
						+ Configuration.ParameterAssignment + "PACKAGENAME:" + Configuration.PackageName
						+ "PACKAGEDECLARATION:" + Configuration.PackageDeclaration + "PACKAGEANNOTATION:"
						+ Configuration.PackageAnnotation + "OVERLOADMETHODSDECLARATIONORDER:"
						+ Configuration.OverloadMethodsDeclarationOrder + "OUTERTYPENUMBER:"
						+ Configuration.OuterTypeNumber + "OUTERTYPEFILENAME:" + Configuration.OuterTypeFilename
						+ "OPERATORWRAP:" + Configuration.OperatorWrap + "ONETOPLEVELCLASS:"
						+ Configuration.OneTopLevelClass + "ONESTATEMENTPERLINE:" + Configuration.OneStatementPerLine
						+ "NONEMPTYATCLAUSEDESCRIPTION:" + Configuration.NonEmptyAtclauseDescription
						+ "NOWHITESPACEBEFORE:" + Configuration.NoWhitespaceBefore + "NOWHITESPACEAFTER:"
						+ Configuration.NoWhitespaceAfter + "NOLINEWRAP:" + Configuration.NoLineWrap + "NOFINALIZER:"
						+ Configuration.NoFinalizer + "NOCLONE:" + Configuration.NoClone + "NEWLINEATENDOFFILE:"
						+ Configuration.NewlineAtEndOfFile + "NESTEDTRYDEPTH:" + Configuration.NestedTryDepth
						+ "NESTEDIFDEPTH:" + Configuration.NestedIfDepth + "NESTEDFORDEPTH:"
						+ Configuration.NestedForDepth + "NEEDBRACESALLOWSINGLELINEIF:"
						+ Configuration.NeedBracesAllowSingleLineIf + "NEEDBRACES:" + Configuration.NeedBraces
						+ "NPATHCOMPLEXITY:" + Configuration.NPathComplexity + "MUTABLEEXCEPTIONCHECK:"
						+ Configuration.MutableExceptionCheck + "MULTIPLEVARIABLEDECLARATIONS:"
						+ Configuration.MultipleVariableDeclarations + "MULTIPLESTRINGLITERALS:"
						+ Configuration.MultipleStringLiterals + "MODIFIERORDER:" + Configuration.ModifierOrder
						+ "MODIFIEDCONTROLVARIABLE:" + Configuration.ModifiedControlVariable + "MISSINGSWITCHDEFAULT:"
						+ Configuration.MissingSwitchDefault + "MISSINGOVERRIDE:" + Configuration.MissingOverride
						+ "MISSINGDEPRECATED:" + Configuration.MissingDeprecated + "MISSINGCTOR:"
						+ Configuration.MissingCtor + "METHODTYPEPARAMETERNAME:" + Configuration.MethodTypeParameterName
						+ "METHODPARAMPAD:" + Configuration.MethodParamPad + "METHODNAMEALLOWCLASSNAME:"
						+ Configuration.MethodNameallowClassName + "METHODNAME:" + Configuration.MethodName
						+ "METHODLENGTH:" + Configuration.MethodLength + "METHODCOUNT:" + Configuration.MethodCount
						+ "MEMBERNAME:" + Configuration.MemberName + "MAGICNUMBER:" + Configuration.MagicNumber
						+ "LOCALVARIABLENAMEALLOWONECHARVARINFORLOOP:"
						+ Configuration.LocalVariableNameallowOneCharVarInForLoop + "LOCALVARIABLENAME:"
						+ Configuration.LocalVariableName + "LOCALFINALVARIABLENAME:"
						+ Configuration.LocalFinalVariableName + "LINELENGTH:" + Configuration.LineLength + "LEFTCURLY:"
						+ Configuration.LeftCurly + "JAVADOCVARIABLE:" + Configuration.JavadocVariable + "JAVADOCTYPE:"
						+ Configuration.JavadocType + "JAVADOCTAGCONTINUATIONINDENTATION:"
						+ Configuration.JavadocTagContinuationIndentation + "JAVADOCSTYLE:" + Configuration.JavadocStyle
						+ "JAVADOCPARAGRAPH:" + Configuration.JavadocParagraph + "JAVADOCPACKAGE:"
						+ Configuration.JavadocPackage + "JAVADOCMETHOD:" + Configuration.JavadocMethod + "JAVANCSS:"
						+ Configuration.JavaNCSS + "INTERFACETYPEPARAMETERNAME:"
						+ Configuration.InterfaceTypeParameterName + "INTERFACEISTYPE:" + Configuration.InterfaceIsType
						+ "INNERTYPELAST:" + Configuration.InnerTypeLast + "INNERASSIGNMENT:"
						+ Configuration.InnerAssignment + "INDENTATIONFORCESTRICTCONDITION:"
						+ Configuration.IndentationForceStrictCondition + "INDENTATION:" + Configuration.Indentation
						+ "IMPORTORDER:" + Configuration.ImportOrder + "IMPORTCONTROL:" + Configuration.ImportControl
						+ "ILLEGALTYPECHECK:" + Configuration.IllegalTypeCheck + "ILLEGALTOKENTEXTCHECK:"
						+ Configuration.IllegalTokenTextCheck + "ILLEGALTOKEN:" + Configuration.IllegalToken
						+ "ILLEGALTHROWS:" + Configuration.IllegalThrows + "ILLEGALINSTANTIATION:"
						+ Configuration.IllegalInstantiation + "ILLEGALIMPORT:" + Configuration.IllegalImport
						+ "ILLEGALCATCH:" + Configuration.IllegalCatch + "HIDEUTILITYCLASSCONSTRUCTOR:"
						+ Configuration.HideUtilityClassConstructor + "HIDDENFIELD:" + Configuration.HiddenField
						+ "HEADERCHECK:" + Configuration.HeaderCheck + "GENERICWHITESPACE:"
						+ Configuration.GenericWhitespace + "FINALPARAMETERS:" + Configuration.FinalParameters
						+ "FINALLOCALVARIABLE:" + Configuration.FinalLocalVariable + "FINALCLASS:"
						+ Configuration.FinalClass + "FILETABCHARACTER:" + Configuration.FileTabCharacter
						+ "FILELENGTH:" + Configuration.FileLength + "FALLTHROUGH:" + Configuration.FallThrough
						+ "EXPLICITINITIALIZATION:" + Configuration.ExplicitInitialization + "EXECUTABLESTATEMENTCOUNT:"
						+ Configuration.ExecutableStatementCount + "EQUALSHASHCODE:" + Configuration.EqualsHashCode
						+ "EQUALSAVOIDNULL:" + Configuration.EqualsAvoidNull + "EMPTYSTATEMENT:"
						+ Configuration.EmptyStatement + "EMPTYLINESEPARATORALLOWNOEMPTYLINEBETWEENFIELDS:"
						+ Configuration.EmptyLineSeparatorallowNoEmptyLineBetweenFields
						+ "EMPTYLINESEPARATORALLOWMULTIPLEEMPTYLINES:"
						+ Configuration.EmptyLineSeparatorallowMultipleEmptyLines + "EMPTYLINESEPARATOR:"
						+ Configuration.EmptyLineSeparator + "EMPTYFORITERATORPAD:" + Configuration.EmptyForIteratorPad
						+ "EMPTYCATCHBLOCK:" + Configuration.EmptyCatchBlock + "EMPTYBLOCK:" + Configuration.EmptyBlock
						+ "DESIGNFOREXTENSION:" + Configuration.DesignForExtension + "DEFAULTCOMESLAST:"
						+ Configuration.DefaultComesLast + "DECLARATIONORDER:" + Configuration.DeclarationOrder
						+ "CYCLOMATICCOMPLEXITY:" + Configuration.CyclomaticComplexity + "CUSTOMIMPORTORDER:"
						+ Configuration.CustomImportOrder + "COVARIANTEQUALS:" + Configuration.CovariantEquals
						+ "CONSTANTNAME:" + Configuration.ConstantName + "CLASSTYPEPARAMETERNAME:"
						+ Configuration.ClassTypeParameterName + "CLASSFANOUTCOMPLEXITYCHECK:"
						+ Configuration.ClassFanOutComplexityCheck + "CLASSDATAABSTRACTIONCOUPLINGCHECK:"
						+ Configuration.ClassDataAbstractionCouplingCheck + "BOOLEANEXPRESSIONCOMPLEXITY:"
						+ Configuration.BooleanExpressionComplexity + "AVOIDSTARIMPORTCHECK:"
						+ Configuration.AvoidStarImportCheck + "AVOIDNESTEDBLOCKS:" + Configuration.AvoidNestedBlocks
						...
						+ "ATCLAUSEORDER:" + Configuration.AtclauseOrder + "ARRAYTYPESTYLE:"
						+ Configuration.ArrayTypeStyle + "ARRAYTRAILINGCOMMA:" + Configuration.ArrayTrailingComma
						+ "ANONINNERLENGTH:" + Configuration.AnonInnerLength + "ANNOTATIONUSESTYLE:"
						+ Configuration.AnnotationUseStyle + "ANNOTATIONLOCATION:" + Configuration.AnnotationLocation
						...
						+ "ABBREVIATIONASWORDINNAMEIGNOREOVERRIDDENMETHODS:"
						+ Configuration.AbbreviationAsWordInNameignoreOverriddenMethods
	...
	public static String returnProduct() {
		return "WRITETAG:" + Configuration.WriteTag + "WHITESPACEAROUNDIGNOREENHANCEDFORCOLON:"
				+ Configuration.WhitespaceAroundIgnoreEnhancedForColon + "WHITESPACEAROUNDALLOWEMPTYTYPES:"
				+ Configuration.WhitespaceAroundAllowEmptyTypes + "WHITESPACEAROUNDALLOWEMPTYMETHODS:"
				+ Configuration.WhitespaceAroundAllowEmptyMethods + "WHITESPACEAROUNDALLOWEMPTYLOOPS:"
				+ Configuration.WhitespaceAroundAllowEmptyLoops + "WHITESPACEAROUNDALLOWEMPTYCTORS:"
				+ Configuration.WhitespaceAroundAllowEmptyCtors + "WHITESPACEAROUND:" + Configuration.WhitespaceAround
				+ "WHITESPACEAFTER:" + Configuration.WhitespaceAfter + "VISIBILITYMODIFIER:"
				+ Configuration.VisibilityModifier + "VARIABLEDECLARATIONUSAGEDISTANCE:"
				+ Configuration.VariableDeclarationUsageDistance + "UPPERELL:" + Configuration.UpperEll
				+ "UNUSEDIMPORTS:" + Configuration.UnusedImports + "UNNECESSARYPARENTHESES:"
				+ Configuration.UnnecessaryParentheses + "UNCOMMENTEDMAIN:" + Configuration.UncommentedMain
				+ "TYPECASTPARENPAD:" + Configuration.TypecastParenPad + "TYPENAME:" + Configuration.TypeName
				+ "TRANSLATION:" + Configuration.Translation + "TRAILINGCOMMENT:" + Configuration.TrailingComment
				+ "TODOCOMMENT:" + Configuration.TodoComment + "THROWSCOUNT:" + Configuration.ThrowsCount + "TW:"
				+ Configuration.TW + "SUPPRESSWARNINGS:" + Configuration.SuppressWarnings + "SUPERFINALIZE:"
				+ Configuration.SuperFinalize + "SUPERCLONE:" + Configuration.SuperClone + "SUMMARYJAVADOC:"
				+ Configuration.SummaryJavadoc + "STRINGLITERALEQUALITY:" + Configuration.StringLiteralEquality
				+ "STATICVARIABLENAME:" + Configuration.StaticVariableName + "SINGLELINEJAVADOC:"
				+ Configuration.SingleLineJavadoc + "SIMPLIFYBOOLEANRETURN:" + Configuration.SimplifyBooleanReturn
				+ "SIMPLIFYBOOLEANEXPRESSION:" + Configuration.SimplifyBooleanExpression + "SEPARATORWRAP:"
				+ Configuration.SeparatorWrap + "RIGHTCURLY:" + Configuration.RightCurly + "RETURNCOUNTCHECK:"
				+ Configuration.ReturnCountCheck + "REQUIRETHIS:" + Configuration.RequireThis + "REGEXPILLEGALPATTERN:"
				+ Configuration.RegexpillegalPattern + "REGEXPIGNORECOMMENTS:" + Configuration.RegexpignoreComments
				+ "REGEXPCHECKFORDUPLICATES:" + Configuration.RegexpcheckForDuplicates + "REGEXPSINGLELINEJAVA:"
				+ Configuration.RegexpSinglelineJava + "REGEXPSINGLELINE:" + Configuration.RegexpSingleline
				+ "REGEXPMULTILINE:" + Configuration.RegexpMultiline + "REGEXPHEADERCHECK:"
				+ Configuration.RegexpHeaderCheck + "REGEXP:" + Configuration.Regexp + "REDUNDANTMODIFIER:"
				+ Configuration.RedundantModifier + "REDUNDANTIMPORT:" + Configuration.RedundantImport + "PARENPAD:"
				+ Configuration.ParenPad + "PARAMETERNUMBER:" + Configuration.ParameterNumber + "PARAMETERNAME:"
				+ Configuration.ParameterName + "PARAMETERASSIGNMENT:" + Configuration.ParameterAssignment
				+ "PACKAGENAME:" + Configuration.PackageName + "PACKAGEDECLARATION:" + Configuration.PackageDeclaration
				+ "PACKAGEANNOTATION:" + Configuration.PackageAnnotation + "OVERLOADMETHODSDECLARATIONORDER:"
				+ Configuration.OverloadMethodsDeclarationOrder + "OUTERTYPENUMBER:" + Configuration.OuterTypeNumber
				+ "OUTERTYPEFILENAME:" + Configuration.OuterTypeFilename + "OPERATORWRAP:" + Configuration.OperatorWrap
				+ "ONETOPLEVELCLASS:" + Configuration.OneTopLevelClass + "ONESTATEMENTPERLINE:"
				+ Configuration.OneStatementPerLine + "NONEMPTYATCLAUSEDESCRIPTION:"
				+ Configuration.NonEmptyAtclauseDescription + "NOWHITESPACEBEFORE:" + Configuration.NoWhitespaceBefore
				+ "NOWHITESPACEAFTER:" + Configuration.NoWhitespaceAfter + "NOLINEWRAP:" + Configuration.NoLineWrap
				+ "NOFINALIZER:" + Configuration.NoFinalizer + "NOCLONE:" + Configuration.NoClone
				+ "NEWLINEATENDOFFILE:" + Configuration.NewlineAtEndOfFile + "NESTEDTRYDEPTH:"
				+ Configuration.NestedTryDepth + "NESTEDIFDEPTH:" + Configuration.NestedIfDepth + "NESTEDFORDEPTH:"
				+ Configuration.NestedForDepth + "NEEDBRACESALLOWSINGLELINEIF:"
				+ Configuration.NeedBracesAllowSingleLineIf + "NEEDBRACES:" + Configuration.NeedBraces
				+ "NPATHCOMPLEXITY:" + Configuration.NPathComplexity + "MUTABLEEXCEPTIONCHECK:"
				+ Configuration.MutableExceptionCheck + "MULTIPLEVARIABLEDECLARATIONS:"
				...
				+ "MODIFIEDCONTROLVARIABLE:" + Configuration.ModifiedControlVariable + "MISSINGSWITCHDEFAULT:"
				+ Configuration.MissingSwitchDefault + "MISSINGOVERRIDE:" + Configuration.MissingOverride
				+ "MISSINGDEPRECATED:" + Configuration.MissingDeprecated + "MISSINGCTOR:" + Configuration.MissingCtor
				+ "METHODTYPEPARAMETERNAME:" + Configuration.MethodTypeParameterName + "METHODPARAMPAD:"
				+ Configuration.MethodParamPad + "METHODNAMEALLOWCLASSNAME:" + Configuration.MethodNameallowClassName
				+ "METHODNAME:" + Configuration.MethodName + "METHODLENGTH:" + Configuration.MethodLength
				+ "METHODCOUNT:" + Configuration.MethodCount + "MEMBERNAME:" + Configuration.MemberName + "MAGICNUMBER:"
				+ Configuration.MagicNumber + "LOCALVARIABLENAMEALLOWONECHARVARINFORLOOP:"
				+ Configuration.LocalVariableNameallowOneCharVarInForLoop + "LOCALVARIABLENAME:"
				+ Configuration.LocalVariableName + "LOCALFINALVARIABLENAME:" + Configuration.LocalFinalVariableName
				+ "LINELENGTH:" + Configuration.LineLength + "LEFTCURLY:" + Configuration.LeftCurly + "JAVADOCVARIABLE:"
				+ Configuration.JavadocVariable + "JAVADOCTYPE:" + Configuration.JavadocType
				+ "JAVADOCTAGCONTINUATIONINDENTATION:" + Configuration.JavadocTagContinuationIndentation
				+ "JAVADOCSTYLE:" + Configuration.JavadocStyle + "JAVADOCPARAGRAPH:" + Configuration.JavadocParagraph
				+ "JAVADOCPACKAGE:" + Configuration.JavadocPackage + "JAVADOCMETHOD:" + Configuration.JavadocMethod
				+ "JAVANCSS:" + Configuration.JavaNCSS + "INTERFACETYPEPARAMETERNAME:"
				+ Configuration.InterfaceTypeParameterName + "INTERFACEISTYPE:" + Configuration.InterfaceIsType
				+ "INNERTYPELAST:" + Configuration.InnerTypeLast + "INNERASSIGNMENT:" + Configuration.InnerAssignment
				+ "INDENTATIONFORCESTRICTCONDITION:" + Configuration.IndentationForceStrictCondition + "INDENTATION:"
				+ Configuration.Indentation + "IMPORTORDER:" + Configuration.ImportOrder + "IMPORTCONTROL:"
				+ Configuration.ImportControl + "ILLEGALTYPECHECK:" + Configuration.IllegalTypeCheck
				+ "ILLEGALTOKENTEXTCHECK:" + Configuration.IllegalTokenTextCheck + "ILLEGALTOKEN:"
				+ Configuration.IllegalToken + "ILLEGALTHROWS:" + Configuration.IllegalThrows + "ILLEGALINSTANTIATION:"
				+ Configuration.IllegalInstantiation + "ILLEGALIMPORT:" + Configuration.IllegalImport + "ILLEGALCATCH:"
				+ Configuration.IllegalCatch + "HIDEUTILITYCLASSCONSTRUCTOR:"
				+ Configuration.HideUtilityClassConstructor + "HIDDENFIELD:" + Configuration.HiddenField
				+ "HEADERCHECK:" + Configuration.HeaderCheck + "GENERICWHITESPACE:" + Configuration.GenericWhitespace
				+ "FINALPARAMETERS:" + Configuration.FinalParameters + "FINALLOCALVARIABLE:"
				+ Configuration.FinalLocalVariable + "FINALCLASS:" + Configuration.FinalClass + "FILETABCHARACTER:"
				+ Configuration.FileTabCharacter + "FILELENGTH:" + Configuration.FileLength + "FALLTHROUGH:"
				+ Configuration.FallThrough + "EXPLICITINITIALIZATION:" + Configuration.ExplicitInitialization
				+ "EXECUTABLESTATEMENTCOUNT:" + Configuration.ExecutableStatementCount + "EQUALSHASHCODE:"
				+ Configuration.EqualsHashCode + "EQUALSAVOIDNULL:" + Configuration.EqualsAvoidNull + "EMPTYSTATEMENT:"
				+ Configuration.EmptyStatement + "EMPTYLINESEPARATORALLOWNOEMPTYLINEBETWEENFIELDS:"
				+ Configuration.EmptyLineSeparatorallowNoEmptyLineBetweenFields
				+ "EMPTYLINESEPARATORALLOWMULTIPLEEMPTYLINES:" + Configuration.EmptyLineSeparatorallowMultipleEmptyLines
				+ "EMPTYLINESEPARATOR:" + Configuration.EmptyLineSeparator + "EMPTYFORITERATORPAD:"
				+ Configuration.EmptyForIteratorPad + "EMPTYCATCHBLOCK:" + Configuration.EmptyCatchBlock + "EMPTYBLOCK:"
				+ Configuration.EmptyBlock + "DESIGNFOREXTENSION:" + Configuration.DesignForExtension
				+ "DEFAULTCOMESLAST:" + Configuration.DefaultComesLast + "DECLARATIONORDER:"
				+ Configuration.DeclarationOrder + "CYCLOMATICCOMPLEXITY:" + Configuration.CyclomaticComplexity
				+ "CUSTOMIMPORTORDER:" + Configuration.CustomImportOrder + "COVARIANTEQUALS:"
				+ Configuration.CovariantEquals + "CONSTANTNAME:" + Configuration.ConstantName
				+ "CLASSTYPEPARAMETERNAME:" + Configuration.ClassTypeParameterName + "CLASSFANOUTCOMPLEXITYCHECK:"
				+ Configuration.ClassFanOutComplexityCheck + "CLASSDATAABSTRACTIONCOUPLINGCHECK:"
				+ Configuration.ClassDataAbstractionCouplingCheck + "BOOLEANEXPRESSIONCOMPLEXITY:"
				+ Configuration.BooleanExpressionComplexity + "AVOIDSTARIMPORTCHECK:"
				+ Configuration.AvoidStarImportCheck + "AVOIDNESTEDBLOCKS:" + Configuration.AvoidNestedBlocks
				+ "AVOIDINLINECONDITIONALS:" + Configuration.AvoidInlineConditionals + "AVOIDESCAPEDUNICODECHARACTERS:"
				+ Configuration.AvoidEscapedUnicodeCharacters + "ATCLAUSEORDER:" + Configuration.AtclauseOrder
				+ "ARRAYTYPESTYLE:" + Configuration.ArrayTypeStyle + "ARRAYTRAILINGCOMMA:"
				+ Configuration.ArrayTrailingComma + "ANONINNERLENGTH:" + Configuration.AnonInnerLength
				+ "ANNOTATIONUSESTYLE:" + Configuration.AnnotationUseStyle + "ANNOTATIONLOCATION:"
				+ Configuration.AnnotationLocation + "ABSTRACTCLASSNAMEIGNORENAME:"
				+ Configuration.AbstractClassNameignoreName + "ABSTRACTCLASSNAMEIGNOREMODIFIER:"
				+ Configuration.AbstractClassNameignoreModifier + "ABSTRACTCLASSNAME:" + Configuration.AbstractClassName
				+ "ABBREVIATIONASWORDINNAMEIGNORESTATIC:" + Configuration.AbbreviationAsWordInNameignoreStatic
				+ "ABBREVIATIONASWORDINNAMEIGNOREOVERRIDDENMETHODS:"
				+ Configuration.AbbreviationAsWordInNameignoreOverriddenMethods + "ABBREVIATIONASWORDINNAMEIGNOREFINAL:"
				+ Configuration.AbbreviationAsWordInNameignoreFinal + "ABBREVIATIONASWORDINNAME:"
				+ Configuration.AbbreviationAsWordInName;
	}
